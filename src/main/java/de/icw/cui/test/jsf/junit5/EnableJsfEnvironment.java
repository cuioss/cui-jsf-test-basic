...
/**
 * Using this annotations at type-level of a junit 5 test enable the myfaces-test-based
 * test-framework for unit-tests. The configuration is implemented using some kind of decorator
 * pattern (roughly). The actual configuration relies on two sources:
 * <ul>
 ...
 *
 * <p>
 * Complex Sample: Use a preconfigured JSF-context with access to the context information like
 * {@link FacesContext}, {@link ComponentConfigurator}, ... as defined within
 * {@link JsfEnvironmentHolder} With this setup you can programmatically access the element
 * </p>
 *
 * <pre>
 * <code>
 ...
 * {@link #useIdentityResourceBundle()}. If it is active it is used as well for resolving
 * the MessageBundle. In case of many annotations of {@link EnableJsfEnvironment} are in the type
 * hierarchy, the one on the most concrete Type will be chosen, usually on the actual unit-test.
 * </p>
 *
 * @author Oliver Wolff
 *
