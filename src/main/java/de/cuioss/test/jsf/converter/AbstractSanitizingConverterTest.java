...
/**
 * Extension of {@linkplain AbstractConverterTest} to also test the sanitizing inside the
...
public abstract class AbstractSanitizingConverterTest<C extends Converter<T>, T> extends AbstractConverterTest<C, T> {
    ...
    /**
     * Create an instance of the object containing a given malicious content that is to be converted
     * into a string by this converter.
     *
     * @param content
     * @return
     */
