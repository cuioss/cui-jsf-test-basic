...
image:https://maven-badges.herokuapp.com/maven-central/io.github.cuioss.test/cui-jsf-test-basic/badge.svg[Maven Central,link=https://maven-badges.herokuapp.com/maven-central/io.github.cuioss.test/cui-jsf-test-basic]
